...
import com.project.smartbuy.filters.JwtTokenFilter;
    ...
    http
      ...
      .authorizeHttpRequests(requests -> {
        requests
          ...
          .requestMatchers(POST, String.format("%s/products/**", apiPrefix)).permitAll() //for test request upload image
      ...
      .cors(httpSecurityCorsConfigurer -> {
          ...
          configuration.setAllowedHeaders(Arrays
                  .asList("authorization", "content-type", "x-auth-token"));
